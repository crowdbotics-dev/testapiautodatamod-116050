...
## Project Structure
    ...
    ├── testapiautodatamod_116050  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_116050`
...
2. Clone this repo and `cd testapiautodatamod_116050`
